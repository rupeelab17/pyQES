...
Usage (from the repo root, after ``uv sync``)::
    ...
    uv run python examples/umep_workflow/run_mag_to_tif.py -z 1.5
    uv run python examples/umep_workflow/run_mag_to_tif.py -z 10 -o examples/umep_workflow/output/mag_10m.tif
"""
